          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="col d-flex justify-content-end">
                ...
                <a href="<?= base_url('chef/create-menu') ?>" class="btn btn-success mb-2">+ Tambah Menu</a>
              </div>
                ...
                <tbody>
                  ...
                  <?php foreach ($listmenu as $item) : ?>
                    <tr>
                      ...
                      <td>
                        <a href="<?= base_url('chef/detail-menu/' . $item['id']) ?>" class="btn btn-primary"><i class="bi bi-eye"></i></a>
                        <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#basicModal<?= $item['id'] ?>"><i class="bi bi-trash"></i></button>
                        <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#stokModal<?= $item['id'] ?>"><i class="bi bi-pencil"></i></button>
                      </td>
                    </tr>
                  <?php endforeach ?>
                </tbody>
